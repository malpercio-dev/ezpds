...
- `src/lib/components/home/` — eight home screen components (IdentityListHome, HomeScreen, DIDDocumentScreen, RecoveryInfoScreen, AlertDetailScreen, RecoveryOverrideScreen, MyAgentsScreen, AgentClaimApprovalScreen) plus DIDAvatar utility component (deterministic DID-derived hue circle)
