<script lang="ts">
  ...
  // The app's gold wax seal — an embossed mark used at brand and ceremonial moments.
  let { size = 72, children }: { size?: number; children: Snippet } = $props();
</script>

<span class="seal" style="width: {size}px; height: {size}px" aria-hidden="true">
  {@render children()}
</span>
