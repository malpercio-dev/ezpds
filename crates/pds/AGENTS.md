...
A follow-on split (design plan: `docs/design-plans/2026-07-13-pds-module-reorganization.md`) will
extract the SSRF/proxy-target half of `resolution.rs` into `identity/proxy.rs`.
