...
pub(super) static MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 46,
        sql: include_str!("migrations/V046__operator_account_audit.sql"),
    },
    Migration {
        version: 47,
    ...
    Migration {
        version: 51,
        sql: include_str!("migrations/V051__account_labels.sql"),
    },
    Migration {
        version: 52,
    ...
    Migration {
        version: 56,
        sql: include_str!("migrations/V056__pending_oauth_authorizations.sql"),
    },
    Migration {
        version: 57,
    ...
    Migration {
        version: 60,
        sql: include_str!("migrations/V060__pending_oauth_push.sql"),
    },
    Migration {
        version: 61,
        sql: include_str!("migrations/V061__oauth_refresh_sessions.sql"),
    },
    Migration {
        version: 62,
        sql: include_str!("migrations/V062__oauth_dpop_jkt_binding.sql"),
    },
    Migration {
        version: 63,
    ...
    Migration {
        version: 67,
        sql: include_str!("migrations/V067__space_writers.sql"),
    },
];
