...
| `spaces` | The Atproto Spaces alpha surface: permissioned space repos with DPoP-bound space credentials, oplog/CAR sync, and simplespace management. | `spaces.enabled`, `signing_key_master_key` |
