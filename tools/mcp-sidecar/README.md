...
| `CUSTOS_MCP_ALLOW_DESTRUCTIVE` | no | Same gate as the stdio server: `1` lists `put_record`/`delete_record` and their space siblings `space_put_record`/`space_delete_record`. |
